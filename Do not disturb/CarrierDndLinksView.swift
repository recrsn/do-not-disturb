...
extension CarrierDndInfo {
  static let airtel = Self(id: "airtel", name: "AirTel", link: "https://www.airtel.in/airtel-dnd/")
  static let jio = Self(
    id: "jio", name: "Jio",
    link: "https://www.jio.com/help/faq/mobile/services/dnd/how-do-i-activate-do-not-disturb-dnd#/")
